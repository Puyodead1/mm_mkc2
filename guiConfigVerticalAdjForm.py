...
# File: guiConfigVerticalAdjForm.pyc (Python 2.5)
...
Filename: guiConfigVerticalAdjForm.py
...
log = initlog('guiConfigVerticalAdjForm')

class ConfigVerticalAdjForm(ConfigForm):
