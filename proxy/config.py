...
POSTAUTH_SLEEP_PERIOD = 600
POSTAUTH_DELAY_HOURS = 1
...
UPG_NEED_APIS = ('getCcInfoByCcNumber', 'check_black_list_for_chip_n_pin', 'getCerePayCfgByAcctId', 'getCerePayUserInfo', 'checkCerePayEmail', 'registerCerePay', 'topup_cerepay', 'getCcInfoByCcId')
